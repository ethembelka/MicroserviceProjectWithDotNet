...
namespace EventBus.AzureServiceBus
{
    public class EventBusServiceBus : BaseEventBus
    {
        ...
        {
            var eventName = @event.GetType().Name; // example: OrderCreatedIntegrationnEvent
        ...
        {
            var subClient = CereateSubscriptionClient(eventName);
        ...
        private SubscriptionClient CereateSubscriptionClient(string eventName)
        {
